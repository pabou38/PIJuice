...
# could be set already by module importing this one, but to make sure
p = "../all_secret"
sys.path.insert(1, p)
...
# python3
def send_pushover(message:str, title= "pabou", priority= 0, sound = "spacealarm"):
...
if __name__ == "__main__":
    send_pushover('testing from main', priority=1)
    time.sleep(2)
